...
\texttt{Controller} sleduje signál změn a pokaždé když se na signálu objeví hodnota (obvykle typu Void), překreslí odpovídající View.
...
Opět je nutné zpropagovat uživatelskou iterakci z View do Coordinatoru pomocí \texttt{Controlleru} a ViewModelu.