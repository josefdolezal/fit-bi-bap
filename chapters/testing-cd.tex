...
Průběžné doručování (z anglického \textit{Continuous delivery}, zkráceně \texttt{CD}) je způsob, kterým lze nasadit nové funkcionality, změny konfigurace či opravy chyb do produkčního prostředí.
...
Přestože pro svou práci nemám reálné produkční prostředí, rozhodl jsem se \texttt{CD} použít pro distribuci testovací verze aplikace.
