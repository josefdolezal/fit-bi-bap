...
Pro zrušení aktuálního tisku lze využít \inlinestr{api/job} s metodou \textit{POST}.
...
Mazání je možné pomocí funkce \inlinestr{api/logs/[filename]} metodou \textit{DELETE}.
