...
Výstupy z \texttt{ViewModelu} jsou pomocí UI bindings napojeny na \texttt{View} v metodě \textit{bindViewModel}, která je volána těsně po načtení \texttt{View} vrstvy do paměti.
