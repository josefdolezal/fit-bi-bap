...
Výstupem jsou zobrazovaná data, která jsou ViewModelem předformátovaná aby je \texttt{Controller} mohl přímo zobrazit pomocí \texttt{View} vrstvy.
...
Výstupy z ViewModelu jsou pomocí UI bindings napojeny na \texttt{View} v metodě \textit{bindViewModel}, která je volána těsně po načtení \texttt{View} vrstvy do paměti.
