...
Tento přístup je v \acrshort{sdk} poskytovaným Applem velmi obvyklý a využívá ho mnoho standardních knihoven.
...
Do této fronty je možné vkládat jednotky práce, \acrshort{gcd} se postará o to aby byly spuštěny na ve správném pořadí.
...
NSOperationQueue a NSOperation je abstrakce nad metodou \acrshort{gcd} zmíněnou víše.
...
\swiftcode{code:rac-signal}{Vytoření signálu v ReactiveCocoa}{assets/code/rac-signal.swift}
