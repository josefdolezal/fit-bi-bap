...
Realm neodděluje standardní {\acrshort{crud} operace, místo toho je zavedena \texttt{write} transakce, v níž je možné CRUD operace využít. Transakce implementuji v ukázce \ref{code:realm-write}.
