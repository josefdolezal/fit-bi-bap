...
\texttt{Provider} je založen na modelových objektech.
...
\texttt{Provider} implementačně sice není relační databází, nabízí ale podobné \acrshort{api} pro relace mezi objekty.
...
\texttt{Provider} neodděluje standardní {\acrshort{crud} operace, místo toho je zavedena \texttt{write} transakce, v níž je možné CRUD operace využít. Transakce implementuji v ukázce \ref{code:realm-write}.
...
\texttt{Provider} umožňuje notifikovat o změnách objektů v databázi.
